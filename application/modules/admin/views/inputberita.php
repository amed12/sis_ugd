<div class="container">	
			...
			<div class="tab-pane well" style="min-height:700px;">
							...
							<div class="thumbnail"s>
									...
									<?php echo form_open_multipart('admin/simpaninputberita',array('class'=>'form-horizontal'));?>
								
										<div class="control-group">
											<label class="control-label">JUDUL BERITA</label>
												<div class="controls">
												<?php
													$judul=array('class'=>'span6','name'=>'judul','value'=>set_value('judul'));
										...
										<div class="control-group">
											<label class="control-label">DESKRIPSI BERITA</label>
												<div class="controls">
												<?php
													$deskripsi=array('class'=>'span6','name'=>'deskripsi','value'=>set_value('deskripsi'));
