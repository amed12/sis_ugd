<center>
	<h5>REKAP ABSENSI GURU SMK PSM 1 KAWEDANAN &nbsp;<!--TAHUN PELAJARAN <font color="blue" id="thnajar"><?php //echo $thn1.'/'.$thn2?></font>--> &nbsp; BULAN: <font color="blue" id="blnlap"><?php echo $bulan?></font> <font color="blue" id="thnlap"><?php echo $thn2?></font></h5>
</center>
