<center>
	<h5>DAFTAR ABSENSI UMUM SISWA SMK PSM 1 KAWEDANAN &nbsp; KELAS <font color="blue"><b><?php echo $kelas;?></b></font><!--&nbsp; TAHUN PELAJARAN <font color="blue" id="thnajar"><?php //echo $thn1.'/'.$thn2?></font> -->&nbsp; BULAN: <font color="blue" id="blnlap"><?php echo $bulan?></font> <font color="blue" id="thnlap"><?php echo $thn2?></font></h5>
</center>
